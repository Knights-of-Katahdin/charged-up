package frc.robot.java.com.pathplanner.lib.commands;

import frc.robot.java.com.pathplanner.lib.controllers.PathFollowingController;
import frc.robot.java.com.pathplanner.lib.path.*;
import frc.robot.java.com.pathplanner.lib.pathfinding.Pathfinding;
import frc.robot.java.com.pathplanner.lib.util.GeometryUtil;
import frc.robot.java.com.pathplanner.lib.util.PPLibTelemetry;
import frc.robot.java.com.pathplanner.lib.util.PathPlannerLogging;
    ...
    if (!skipUpdates && Pathfinding.isNewPathAvailable()) {
      ...
      if (currentPath != null) {
        ...
        ChassisSpeeds fieldRelativeSpeeds =
            ChassisSpeeds.fromFieldRelativeSpeeds(currentSpeeds, currentPose.getRotation());
